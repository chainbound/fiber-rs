...
pub fn append_api_key<T>(req: &mut Request<T>, key: &str) {
...
pub fn append_client_version<T>(req: &mut Request<T>) {
...
pub fn append_metadata<T>(req: &mut Request<T>, api_key: &str) {
